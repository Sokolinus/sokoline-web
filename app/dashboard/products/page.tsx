  ...
  return (
    <div className="space-y-12">
      ...
      <div className="flex justify-between items-end">
        ...
        <button className="bg-sokoline-accent text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-xs flex items-center gap-3 hover:bg-sokoline-accent-hover transition-all shadow-xl shadow-sokoline-accent/20 active:scale-95">
          <Plus size={18} />
          New Product
        </button>
      </div>
