...
export default async function Home() {
  ...
  return (
    <main className="mb-20 font-sans">
      <HeroSection />
      
      <div className="max-w-7xl mx-auto px-6">
        {/* Newest Items Section */}
        <div className="mt-12 px-6 py-12 bg-gray-100 rounded-3xl">
              ...
              {categories.map((category) => (
                  <div key={category.id}>
                      <Link href={`/products?category=${category.slug}`}>
                          <div className="p-6 bg-white rounded-2xl hover:shadow-md transition-all text-center border border-black/5">
        ...
        <footer className="mt-12 py-12 px-10 flex flex-col md:flex-row justify-between bg-black rounded-3xl text-white">
