...
export default function HeroSection() {
  return (
    <section className="relative flex min-h-[820px] w-full items-center overflow-hidden bg-[#8484F6] py-16 md:py-28 text-white">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-12 px-6 md:gap-16 md:px-8 lg:grid-cols-2">
        ...
        {/* Phone Mockup - Static Loading for performance, Larger on Mobile */}
        <div className="relative order-2 flex h-[480px] sm:h-[550px] md:h-[650px] items-center justify-center lg:order-1 lg:h-[750px]">
          ...
          <div className="relative z-10 rotate-[5deg]">
            ...
            <div 
              ...
              style={{
                /* Larger mobile size (95vmin), slightly smaller desktop (80vmin) */
                width: 'calc(var(--phone-size, 95vmin) / 2.525)',
                height: 'calc(2.15 * (var(--phone-size, 95vmin) / 2.525))',
                borderRadius: 'calc((var(--phone-size, 95vmin) / 2.525) / 5)',
                maxHeight: '700px',
            ...
            >
              ...
              <div className="relative w-full h-full bg-white rounded-[calc((var(--phone-size,95vmin)/2.525)/5.8)] overflow-hidden shadow-inner border-[4px] md:border-[6px] border-white">
        ...
        {/* Content */}
         <div className="order-1 z-20 space-y-6 text-center md:space-y-10 lg:order-2 lg:-ml-20 lg:text-left">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-2 font-logo md:pt-4 lg:justify-start">
