          ...
          <div className="relative z-10 rotate-[5deg] mb-12 lg:mb-16">
            ...
            >
              ...
              <div className="relative w-full h-full bg-white rounded-[calc((var(--phone-size,110vmin)/2.525)/5.4)] overflow-hidden shadow-inner border-[2px] md:border-[3px] border-white">
                ...
                <div className="absolute top-1 left-1/2 -translate-x-1/2 w-6 md:w-8 h-0.5 bg-black/5 rounded-full z-30" />

                {/* Refined Dynamic Island */}
                <div className="absolute top-2.5 md:top-3 left-1/2 -translate-x-1/2 w-14 md:w-16 h-3.5 md:h-4 bg-black rounded-full z-30 flex items-center justify-end px-1.5 md:px-2">
